...
#include "NativizedAssets/Public/PickupActorInterface__pf563933975.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodePickupActorInterface__pf563933975() {}
// Cross Module References
	...
	NATIVIZEDASSETS_API UFunction* Z_Construct_UFunction_UPickupActorInterface_C_bpf__Drop__pf();
	NATIVIZEDASSETS_API UFunction* Z_Construct_UFunction_UPickupActorInterface_C_bpf__Pickup__pf();
...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_UPickupActorInterface_C_bpf__Drop__pf()
	{
		...
		UFunction* ReturnFunction = static_cast<UFunction*>(StaticFindObjectFast( UFunction::StaticClass(), Outer, TEXT("Drop") ));
		if (!ReturnFunction)
		{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPickupActorInterface_C_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UPickupActorInterface_C_bpf__Drop__pf, "Drop" }, // 1527402739
		{ &Z_Construct_UFunction_UPickupActorInterface_C_bpf__Pickup__pf, "Pickup" }, // 15759863
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPickupActorInterface_C_Statics::Class_MetaDataParams[] = {
		...
		{ "ReplaceConverted", "/Game/VirtualRealityBP/Blueprints/PickupActorInterface.PickupActorInterface_C" },
	};
#endif
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UPickupActorInterface_C_Statics::ClassParams = {
		...
		0,
		0x000040A1u,
		METADATA_PARAMS(Z_Construct_UClass_UPickupActorInterface_C_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UPickupActorInterface_C_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UPickupActorInterface_C()
	{
		UPackage* OuterPackage = FindOrConstructDynamicTypePackage(TEXT("/Game/VirtualRealityBP/Blueprints/PickupActorInterface"));
	...
	IMPLEMENT_DYNAMIC_CLASS(UPickupActorInterface_C, TEXT("PickupActorInterface_C"), 315450095);
	template<> NATIVIZEDASSETS_API UClass* StaticClass<UPickupActorInterface_C>()
	{
		return UPickupActorInterface_C::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UPickupActorInterface_C(Z_Construct_UClass_UPickupActorInterface_C, &UPickupActorInterface_C::StaticClass, TEXT("/Game/VirtualRealityBP/Blueprints/PickupActorInterface"), TEXT("PickupActorInterface_C"), true, TEXT("/Game/VirtualRealityBP/Blueprints/PickupActorInterface"), TEXT("/Game/VirtualRealityBP/Blueprints/PickupActorInterface.PickupActorInterface_C"), nullptr);
