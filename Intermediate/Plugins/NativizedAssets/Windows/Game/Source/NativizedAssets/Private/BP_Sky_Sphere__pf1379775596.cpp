...
void ABP_Sky_Sphere_C__pf1379775596::bpf__UpdateSunDirection__pf()
{
	...
	FColor  __Local__9 = FColor(0,0,0,255);
	bpfv__CallFunc_Conv_ColorToLinearColor_ReturnValue__pf = UKismetMathLibrary::Conv_ColorToLinearColor(((::IsValid(bpv__Directionalxlightxactor__pfTT) && ::IsValid((*(AccessPrivateProperty<ULightComponent* >((bpv__Directionalxlightxactor__pfTT), ALight::__PPO__LightComponent() ))))) ? ((*(AccessPrivateProperty<ULightComponent* >((bpv__Directionalxlightxactor__pfTT), ALight::__PPO__LightComponent() )))->LightColor) : (__Local__9)));
	if(::IsValid(bpv__Skyxmaterial__pfT))
	{
...
void ABP_Sky_Sphere_C__pf1379775596::bpf__RefreshMaterial__pf()
{
	...
	do
	{
		...
		case 3:
			{
				FColor  __Local__10 = FColor(0,0,0,255);
				bpfv__CallFunc_Conv_ColorToLinearColor_ReturnValue__pf = UKismetMathLibrary::Conv_ColorToLinearColor(((::IsValid(bpv__Directionalxlightxactor__pfTT) && ::IsValid((*(AccessPrivateProperty<ULightComponent* >((bpv__Directionalxlightxactor__pfTT), ALight::__PPO__LightComponent() ))))) ? ((*(AccessPrivateProperty<ULightComponent* >((bpv__Directionalxlightxactor__pfTT), ALight::__PPO__LightComponent() )))->LightColor) : (__Local__10)));
				if(::IsValid(bpv__Skyxmaterial__pfT))
				{
					bpv__Skyxmaterial__pfT->UMaterialInstanceDynamic::SetVectorParameterValue(FName(TEXT("Sun color")), bpfv__CallFunc_Conv_ColorToLinearColor_ReturnValue__pf);
				}
...
void ABP_Sky_Sphere_C__pf1379775596::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	{
		{77, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Engine/EngineSky/SM_SkySphere.SM_SkySphere 
		{78, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Engine/EngineSky/M_Sky_Panning_Clouds2.M_Sky_Panning_Clouds2 
		{79, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  CurveLinearColor /Engine/EngineSky/C_Sky_Horizon_Color.C_Sky_Horizon_Color 
		{80, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  CurveLinearColor /Engine/EngineSky/C_Sky_Zenith_Color.C_Sky_Zenith_Color 
		{81, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  CurveLinearColor /Engine/EngineSky/C_Sky_Cloud_Color.C_Sky_Cloud_Color 
	};
...
void ABP_Sky_Sphere_C__pf1379775596::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{82, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.DirectionalLight 
