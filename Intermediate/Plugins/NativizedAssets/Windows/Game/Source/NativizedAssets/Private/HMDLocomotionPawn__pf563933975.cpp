...
AHMDLocomotionPawn_C__pf563933975::AHMDLocomotionPawn_C__pf563933975(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	(((UBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__TraceDirection__pf), false, 0));
	...
	auto& __Local__2 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__TeleportPin__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AHMDLocomotionPawn_C__pf563933975::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	(((UBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__TeleportPin__pf), true, 0));
	...
	auto& __Local__3 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Ring__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__3 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AHMDLocomotionPawn_C__pf563933975::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	...
	auto& __Local__4 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Arrow__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__4 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AHMDLocomotionPawn_C__pf563933975::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
...
void AHMDLocomotionPawn_C__pf563933975::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__6 = NewObject<UInputKeyDelegateBinding>(InDynamicClass, UInputKeyDelegateBinding::StaticClass(), TEXT("InputKeyDelegateBinding_1"), (EObjectFlags)0x00000000);
	...
	__Local__8.InputActionName = FName(TEXT("HMDTeleport"));
	__Local__8.FunctionNameToBind = FName(TEXT("InpActEvt_HMDTeleport_K2Node_InputActionEvent_0"));
	auto& __Local__9 = __Local__5->InputActionDelegateBindings[1];
	__Local__9.InputActionName = FName(TEXT("HMDTeleport"));
	__Local__9.InputKeyEvent = EInputEvent::IE_Released;
	__Local__9.FunctionNameToBind = FName(TEXT("InpActEvt_HMDTeleport_K2Node_InputActionEvent_1"));
	__Local__6->InputKeyDelegateBindings = TArray<FBlueprintInputKeyDelegateBinding> ();
	__Local__6->InputKeyDelegateBindings.AddUninitialized(1);
	FBlueprintInputKeyDelegateBinding::StaticStruct()->InitializeStruct(__Local__6->InputKeyDelegateBindings.GetData(), 1);
	auto& __Local__10 = __Local__6->InputKeyDelegateBindings[0];
	__Local__10.InputChord.Key = FKey(TEXT("R"));
	__Local__10.FunctionNameToBind = FName(TEXT("InpActEvt_R_K2Node_InputKeyEvent_0"));
	__Local__7->InputAxisDelegateBindings = TArray<FBlueprintInputAxisDelegateBinding> ();
	__Local__7->InputAxisDelegateBindings.AddUninitialized(4);
	FBlueprintInputAxisDelegateBinding::StaticStruct()->InitializeStruct(__Local__7->InputAxisDelegateBindings.GetData(), 4);
	auto& __Local__11 = __Local__7->InputAxisDelegateBindings[0];
	__Local__11.InputAxisName = FName(TEXT("TeleportDirectionRight"));
	__Local__11.bOverrideParentBinding = false;
	auto& __Local__12 = __Local__7->InputAxisDelegateBindings[1];
	__Local__12.InputAxisName = FName(TEXT("TeleportDirectionUp"));
	__Local__12.bOverrideParentBinding = false;
	auto& __Local__13 = __Local__7->InputAxisDelegateBindings[2];
	__Local__13.InputAxisName = FName(TEXT("TeleportDirectionRight"));
	__Local__13.bOverrideParentBinding = false;
	auto& __Local__14 = __Local__7->InputAxisDelegateBindings[3];
	__Local__14.InputAxisName = FName(TEXT("TeleportDirectionUp"));
...
void AHMDLocomotionPawn_C__pf563933975::bpf__ExecuteUbergraph_HMDLocomotionPawn__pf_4(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 10:
			{
				UKismetSystemLibrary::Delay(this, bpv__FadeOutDuration__pf, FLatentActionInfo(1, 1129173594, TEXT("ExecuteUbergraph_HMDLocomotionPawn_4"), this));
				__CurrentState = -1;
				break;
			}
		case 19:
