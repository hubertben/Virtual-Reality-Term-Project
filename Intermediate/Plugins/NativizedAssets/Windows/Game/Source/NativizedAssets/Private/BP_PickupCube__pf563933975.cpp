...
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ABP_PickupCube_C__pf563933975::StaticClass() == GetClass()))
	{
		ABP_PickupCube_C__pf563933975::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	if(__Local__0)
	{
		...
		(((UBoolProperty*)__Local__2)->SetPropertyValue_InContainer((__Local__0), true, 0));
		...
		(((UBoolProperty*)__Local__5)->SetPropertyValue_InContainer((__Local__0), true, 0));
...
void ABP_PickupCube_C__pf563933975::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	(((UBoolProperty*)__Local__9)->SetPropertyValue_InContainer((__Local__8), false, 0));
}
PRAGMA_ENABLE_OPTIMIZATION
...
void ABP_PickupCube_C__pf563933975::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{69, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/VirtualRealityBP/Blueprints/PickupActorInterface.PickupActorInterface_C 
