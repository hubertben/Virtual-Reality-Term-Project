...
void ABP_LightStudio_C__pf1079297466::bpf__UserConstructionScript__pf()
{
	...
	do
	{
		...
		case 36:
			{
				bpfv__CallFunc_CreateDynamicMaterialInstance_ReturnValue_1__pf = UKismetMaterialLibrary::CreateDynamicMaterialInstance(this, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_LightStudio_C__pf1079297466::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed), FName(TEXT("None")));
			}
		case 37:
			{
		...
		case 4:
			{
				...
				bpfv__CallFunc_AddComponent_ReturnValue_1__pf = CastChecked<UDirectionalLightComponent>(AActor::AddComponent(FName(TEXT("NODE_AddDirectionalLightComponent-0")), false, bpfv__Temp_struct_Variable_1__pf, this), ECastCheckedType::NullAllowed);
			}
		case 5:
			{
...
void ABP_LightStudio_C__pf1079297466::bpf__AtmosphereDensity__pf()
{
	...
	do
	{
		...
		case 2:
			{
				bpfv__Temp_struct_Variable_1__pf = FTransform( FQuat(0.000000,-0.000000,0.000000,1.000000), FVector(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000) );
				bpfv__CallFunc_AddComponent_ReturnValue_1__pf = CastChecked<UAtmosphericFogComponent>(AActor::AddComponent(FName(TEXT("NODE_AddAtmosphericFogComponent-0")), false, bpfv__Temp_struct_Variable_1__pf, this), ECastCheckedType::NullAllowed);
			}
		case 3:
			{
...
void ABP_LightStudio_C__pf1079297466::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	{
		{104, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/StarterContent/Blueprints/Assets/Skybox.Skybox 
		{105, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Game/StarterContent/Blueprints/Assets/M_LightStage_Skybox_Master.M_LightStage_Skybox_Master 
		{106, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/StarterContent/Blueprints/Assets/SM_Arrows.SM_Arrows 
		{107, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Game/StarterContent/Blueprints/Assets/M_LightStage_Arrows.M_LightStage_Arrows 
		{108, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  CurveLinearColor /Game/StarterContent/Blueprints/Assets/SunlightColorLUT.SunlightColorLUT 
		{109, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  CurveFloat /Game/StarterContent/Blueprints/Assets/FogBrightnessLUT.FogBrightnessLUT 
		{110, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  TextureCube /Game/StarterContent/HDRI/HDRI_Epic_Courtyard_Daylight.HDRI_Epic_Courtyard_Daylight 
		{111, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  MaterialInstanceConstant /Game/StarterContent/Blueprints/Assets/M_LightStage_Skybox_Black.M_LightStage_Skybox_Black 
		{112, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  MaterialInstanceConstant /Game/StarterContent/Blueprints/Assets/M_LightStage_Skybox_HDRI.M_LightStage_Skybox_HDRI 
	};
...
void ABP_LightStudio_C__pf1079297466::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{113, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.ExponentialHeightFogComponent 
		{114, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.SkyLightComponent 
		...
		{115, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.AtmosphericFogComponent 
		...
		{116, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.DirectionalLightComponent 
		...
		{117, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.MaterialInstance 
		{118, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.Texture 
		...
		{119, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.CurveFloat 
