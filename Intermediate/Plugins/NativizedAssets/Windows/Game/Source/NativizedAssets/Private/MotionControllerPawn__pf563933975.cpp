...
AMotionControllerPawn_C__pf563933975::AMotionControllerPawn_C__pf563933975(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	(((UBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__VROrigin__pf), false, 0));
	...
	(((UBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Camera__pf), false, 0));
...
void AMotionControllerPawn_C__pf563933975::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__2 = NewObject<UInputActionDelegateBinding>(InDynamicClass, UInputActionDelegateBinding::StaticClass(), TEXT("InputActionDelegateBinding_1"), (EObjectFlags)0x00000000);
	InDynamicClass->DynamicBindingObjects.Add(__Local__2);
	auto __Local__3 = NewObject<UInputAxisDelegateBinding>(InDynamicClass, UInputAxisDelegateBinding::StaticClass(), TEXT("InputAxisDelegateBinding_1"), (EObjectFlags)0x00000000);
	InDynamicClass->DynamicBindingObjects.Add(__Local__3);
	__Local__2->InputActionDelegateBindings = TArray<FBlueprintInputActionDelegateBinding> ();
	__Local__2->InputActionDelegateBindings.AddUninitialized(8);
	FBlueprintInputActionDelegateBinding::StaticStruct()->InitializeStruct(__Local__2->InputActionDelegateBindings.GetData(), 8);
	auto& __Local__4 = __Local__2->InputActionDelegateBindings[0];
	__Local__4.InputActionName = FName(TEXT("GrabLeft"));
	__Local__4.FunctionNameToBind = FName(TEXT("InpActEvt_GrabLeft_K2Node_InputActionEvent_6"));
	auto& __Local__5 = __Local__2->InputActionDelegateBindings[1];
	__Local__5.InputActionName = FName(TEXT("GrabRight"));
	__Local__5.InputKeyEvent = EInputEvent::IE_Released;
	__Local__5.FunctionNameToBind = FName(TEXT("InpActEvt_GrabRight_K2Node_InputActionEvent_5"));
	auto& __Local__6 = __Local__2->InputActionDelegateBindings[2];
	__Local__6.InputActionName = FName(TEXT("GrabRight"));
	__Local__6.FunctionNameToBind = FName(TEXT("InpActEvt_GrabRight_K2Node_InputActionEvent_4"));
	auto& __Local__7 = __Local__2->InputActionDelegateBindings[3];
	__Local__7.InputActionName = FName(TEXT("GrabLeft"));
	__Local__7.InputKeyEvent = EInputEvent::IE_Released;
	__Local__7.FunctionNameToBind = FName(TEXT("InpActEvt_GrabLeft_K2Node_InputActionEvent_7"));
	auto& __Local__8 = __Local__2->InputActionDelegateBindings[4];
	__Local__8.InputActionName = FName(TEXT("TeleportRight"));
	__Local__8.FunctionNameToBind = FName(TEXT("InpActEvt_TeleportRight_K2Node_InputActionEvent_0"));
	auto& __Local__9 = __Local__2->InputActionDelegateBindings[5];
	__Local__9.InputActionName = FName(TEXT("TeleportRight"));
	__Local__9.InputKeyEvent = EInputEvent::IE_Released;
	__Local__9.FunctionNameToBind = FName(TEXT("InpActEvt_TeleportRight_K2Node_InputActionEvent_1"));
	auto& __Local__10 = __Local__2->InputActionDelegateBindings[6];
	__Local__10.InputActionName = FName(TEXT("TeleportLeft"));
	__Local__10.FunctionNameToBind = FName(TEXT("InpActEvt_TeleportLeft_K2Node_InputActionEvent_2"));
	auto& __Local__11 = __Local__2->InputActionDelegateBindings[7];
	__Local__11.InputActionName = FName(TEXT("TeleportLeft"));
	__Local__11.InputKeyEvent = EInputEvent::IE_Released;
	__Local__11.FunctionNameToBind = FName(TEXT("InpActEvt_TeleportLeft_K2Node_InputActionEvent_3"));
	__Local__3->InputAxisDelegateBindings = TArray<FBlueprintInputAxisDelegateBinding> ();
	__Local__3->InputAxisDelegateBindings.AddUninitialized(4);
	FBlueprintInputAxisDelegateBinding::StaticStruct()->InitializeStruct(__Local__3->InputAxisDelegateBindings.GetData(), 4);
	auto& __Local__12 = __Local__3->InputAxisDelegateBindings[0];
	__Local__12.InputAxisName = FName(TEXT("MotionControllerThumbRight_X"));
	__Local__12.bOverrideParentBinding = false;
	auto& __Local__13 = __Local__3->InputAxisDelegateBindings[1];
	__Local__13.InputAxisName = FName(TEXT("MotionControllerThumbRight_Y"));
	__Local__13.bOverrideParentBinding = false;
	auto& __Local__14 = __Local__3->InputAxisDelegateBindings[2];
	__Local__14.InputAxisName = FName(TEXT("MotionControllerThumbLeft_Y"));
	__Local__14.bOverrideParentBinding = false;
	auto& __Local__15 = __Local__3->InputAxisDelegateBindings[3];
...
void AMotionControllerPawn_C__pf563933975::bpf__ExecuteUbergraph_MotionControllerPawn__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 46:
			{
				UKismetSystemLibrary::Delay(this, bpv__FadeOutDuration__pf, FLatentActionInfo(1, 614746158, TEXT("ExecuteUbergraph_MotionControllerPawn_2"), this));
				__CurrentState = -1;
				break;
			}
		case 49:
		...
		case 50:
			{
				...
				if (!((::IsValid(b0l__K2Node_CustomEvent_MotionController__pf)) ? (b0l__K2Node_CustomEvent_MotionController__pf->bpv__IsValidTeleportDestination__pf) : (__Local__17)))
				{
					__CurrentState = 53;
					break;
				}
		...
		case 56:
			{
				...
				if (!((::IsValid(bpv__LeftController__pf)) ? (bpv__LeftController__pf->bpv__IsTeleporterActive__pf) : (__Local__18)))
				{
					__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
					break;
				}
		...
		case 58:
			{
				...
				if (!((::IsValid(bpv__RightController__pf)) ? (bpv__RightController__pf->bpv__IsTeleporterActive__pf) : (__Local__19)))
				{
					__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
					break;
				}
...
void AMotionControllerPawn_C__pf563933975::bpf__ExecuteUbergraph_MotionControllerPawn__pf_10(int32 bpp__EntryPoint__pf)
{
	...
	if (!((::IsValid(bpv__LeftController__pf)) ? (bpv__LeftController__pf->bpv__IsTeleporterActive__pf) : (__Local__21)))
	{
		return; //KCST_EndOfThreadIfNot
	}
...
void AMotionControllerPawn_C__pf563933975::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{33, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.PlayerCameraManager 
		...
		{10, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.Pawn 
		...
		{59, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Enum /Script/InputCore.EControllerHand 
