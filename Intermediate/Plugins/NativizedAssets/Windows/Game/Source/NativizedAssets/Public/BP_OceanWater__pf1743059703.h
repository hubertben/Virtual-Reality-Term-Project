...
#include "BP_OceanWater__pf1743059703.generated.h"
...
class ABP_OceanWater_C__pf1743059703 : public AActor
{
public:
	GENERATED_BODY()
	...
	ABP_OceanWater_C__pf1743059703(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
